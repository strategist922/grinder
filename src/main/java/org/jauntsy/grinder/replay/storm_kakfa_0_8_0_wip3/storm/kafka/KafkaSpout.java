...
import org.jauntsy.grinder.replay.storm_kakfa_0_8_0_wip3.storm.kafka.PartitionManager.KafkaMessageId;
...
public class KafkaSpout extends BaseRichSpout {
    public static class MessageAndRealOffset {
        ...
        public MessageAndRealOffset(Message msg, String topic, String hostname, int port, int partition, long offset, long nextOffset) {
            this.msg = msg;
            this.topic = topic;
	...
	_state = new ZkState(stateConf);
        ...
        _connections = new DynamicPartitionConnections(conf, _spoutConfig);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(_spoutConfig.kafkaScheme.getOutputFields());
    }
